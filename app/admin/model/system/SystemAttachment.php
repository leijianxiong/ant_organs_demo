...
class SystemAttachment extends BaseModel
{
    ...
    public static function getImageList($where)
    {
        ...
        foreach ($list as &$item){
            $item['satt_dir'] = (strpos($item['satt_dir'],$site_url) !== false)?$item['satt_dir']:$site_url.$item['satt_dir'];
            $item['att_dir'] = (strpos($item['att_dir'],$site_url) !== false)?$item['satt_dir']:$site_url.$item['att_dir'];
        }
