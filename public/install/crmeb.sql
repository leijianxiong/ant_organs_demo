...
(1, 'admin', '31f9abf61ad21a39fe44b0790e1a4f6d', 'admin', '1', '127.0.0.1', 1565746535, 1557470447, 0, 0, 1, 0),
(2, 'crmeb', '921395ab5171811a2199cf8de5f5275a', 'crmeb3.0公测', '2', '27.38.242.78', 1565715816, 1558690548, 0, 1, 1, 0);
...
(1, 'site_name', 'text', 'input', 1, '', 0, 'required:true', 100, 0, '"CRMEB\\u5ba2\\u6e90"', '网站名称', '网站名称', 0, 1),
(2, 'site_url', 'text', 'input', 1, '', 0, 'required:true,url:true', 100, 0, '"http:\\/\\/kaifa.crmeb.net"', '网站地址', '网站地址', 0, 1),
(3, 'site_logo', 'upload', NULL, 1, NULL, 1, NULL, 0, 0, '""', '后台LOGO', '左上角logo,建议尺寸[170*50]', 0, 1),
(4, 'site_phone', 'text', 'input', 1, '', 0, '', 100, 0, '""', '联系电话', '联系电话', 0, 1),
(5, 'seo_title', 'text', 'input', 1, '', 0, 'required:true', 100, 0, '"crmeb\\u7535\\u5546\\u7cfb\\u7edf"', 'SEO标题', 'SEO标题', 0, 1),
(6, 'site_email', 'text', 'input', 1, '', 0, 'email:true', 100, 0, '"admin@xazbkj.com"', '联系邮箱', '联系邮箱', 0, 1),
(7, 'site_qq', 'text', 'input', 1, '', 0, 'qq:true', 100, 0, '"98718401"', '联系QQ', '联系QQ', 0, 1),
...
(46, 'system_express_app_code', 'text', 'input', 10, '', 0, '', 100, 0, '"f3d5ac81211e4eed8a7716f9008402a8"', '快递查询密钥', '阿里云快递查询接口密钥购买地址：https://market.aliyun.com/products/56928004/cmapi021863.html', 0, 1),
...
(61, 'api', 'text', 'input', 2, '', 0, '', 100, 0, '"\\/api\\/wechat\\/serve"', '接口地址', '微信接口例如：http://www.abc.com/wap/wechat/serve', 0, 1),
...
(107, 'routine_index_logo', 'upload', NULL, 7, NULL, 1, NULL, NULL, NULL, '"http:\\/\\/kaifa.crmeb.net\\/uploads\\/attach\\/2019\\/08\\/20190801\\/deb30359d22c0b80f3cece86cb462104.png"', '小程序主页logo图标', '小程序主页logo图标尺寸(127*45)', 0, 1),
...
(123, 'sms_account', 'text', 'input', 18, NULL, NULL, '', 100, NULL, '"tangkai"', '账号', '短信后台的登录账号', 0, 1),
(137, 'sms_token', 'text', 'input', 18, NULL, NULL, '', 100, NULL, '"tangkai123"', 'token/密码', 'token(注册时候的密码)', 0, 1),
...
(476, 474, '', '短信账号', 'admin', 'sms.smsAdmin', 'index', '[]', 0, 1, 1),
...
(2, '公测管理员', '23,24,146,147,264,265,266,263,261,262,25,142,143,369,370,285,26,190,191,394,208,207,206,198,199,200,201,202,203,204,205,197,196,192,193,194,195,329,334,335,290,170,224,225,226,227,228,177,398,399,407,406,400,401,402,403,405,456,337,353,371,450,415,286,148,149,229,230,231,232,233,234,235,150,352,271,254,366,368,367,272,333,238,273,473,241,349,351,350,287,306,239,307,179,217,219,218,216,312,308,313,288,293,341,340,296,318,317,316,315,314,294,300,301,302,244,295,305,304,303,374,246,297,319,321,320,269,376,451,422,423,424,425,426,427,354,12,97,98,99,30,93,89,124,92,91,90,123,31,94,95,96,37,19,73,42,115,116,43,44,45,175,209,210,222,223,211,212,213,214,215,80,283,72,38,41,39,40,284,71,33,113,114,34,35,36,21,469,130,131,173,276,362,365,364,363,386,387,388,389,390,392,393,453,278,377,447,439,444,445,446,443,442,441,440,379,448,380,382,381,467,9,52,109,110,57,58,70,7,46,106,107,47,49,50,51,69,252,237,0,151,11,289', 1, 1);
...
CREATE TABLE IF NOT EXISTS `eb_token` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `uid` int(11) NOT NULL DEFAULT '0' COMMENT '用户uid',
  `rand_string` varchar(10) NOT NULL DEFAULT '' COMMENT '10位随机字符串',
  `add_time` int(11) NOT NULL DEFAULT '0' COMMENT '添加时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='保存token随机字符串' AUTO_INCREMENT=1 ;
